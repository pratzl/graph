...
#  if 0
  ...
  vertex_edge_iterator create_edge(graph_type&, vertex_key_type, const edge_value_type&);
  vertex_edge_iterator create_edge(graph_type&, vertex_key_type, edge_value_type&&);
